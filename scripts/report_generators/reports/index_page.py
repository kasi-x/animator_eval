...
_CATALOG: list[dict] = [
    ...
    {"file": "hr_brief_index.html",        "title": "現場 Workflow 分析 Brief",      "subtitle": "スタジオ HR・制作デスク向け",        "desc": "配置適合度・メンティー M̂ シフト・後継者プロファイル・チーム組成。",  "category": "brief", "sources": "meta_hr_*"},
    ...
    {"file": "mgmt_director_mentor.html",  "title": "監督共起後 5 年メンティー M̂ プロファイル",     "subtitle": "M̂_d EB 縮小推定 + Null モデル",     "desc": "監督ノードの下流 5 年メンティー集団の M̂ シフト分布（記述的プロファイル）。","category": "hr", "sources": "meta_hr_mentor_card"},
    ...
    {"file": "biz_exposure_gap.html","title": "露出機会ギャップ人材プール",   "subtitle": "U_p スコア分布 / アーキタイプ",      "desc": "ネットワーク到達範囲に対し露出が少ない人物群の記述。","category": "biz", "sources": "meta_biz_undervalued"},
