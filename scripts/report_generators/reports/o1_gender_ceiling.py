...
SPEC = make_default_spec(
    ...
    audience='policy',
    sensitivity_grid=[
        SensitivityAxis(name='schoenfeld_test_alpha', values=[0.05]),
        SensitivityAxis(name='cohort_breakdown', values=['5y', '10y']),
        SensitivityAxis(name='permutation_n_rounds', values=[1000]),
    ],
    claim=(
