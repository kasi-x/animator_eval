...
KNOWN_ROLES_JA: set[str] = {
    # Direction
    "監督", "総監督", "副監督", "シリーズディレクター",
    # Script
    "脚本", "シリーズ構成", "構成",
    # Storyboard / Episode direction
    "絵コンテ", "コンテ", "演出", "演出助手", "アシスタントディレクター",
    # Animation supervision
    "作画監督", "総作画監督", "アクション作画監督", "作画監督補佐",
    # Key animation / In-between
    "原画", "第二原画", "作画", "アニメーター", "原動画",
    "動画", "動画検査", "動画チェック", "動画チェッカー", "動仕",
    # Finishing / Inspection
    "仕上げ", "仕上", "仕上検査", "仕上げ検査", "検査",
    "彩色", "デジタルペイント", "セル検査", "色指定検査",
    "モデルチェック", "ファイナルチェック",
    # Design
    "キャラクターデザイン", "サブキャラクターデザイン",
    "ゲストキャラクターデザイン", "ゲストキャラデザイン", "デザインワークス",
    "メカニックデザイン", "メカニカルデザイン", "メカデザイン",
    # Art / Background
    "美術監督", "美術", "美術補", "美術設定", "背景", "背景美術",
    "色彩設計", "色彩設計補佐", "色彩設定", "色指定",
    # Photography
    "撮影監督", "撮影", "撮影監督補佐", "デジタル撮影", "線撮影",
    # Sound
    "音響監督", "音楽", "音楽監督", "音響効果", "音響制作", "音響制作担当",
    "効果", "録音", "音楽プロデューサー", "音楽制作", "音楽協力",
    # Production management
    "プロデューサー", "アニメーションプロデューサー",
    "アシスタントプロデューサー", "アソシエイトプロデューサー",
    "制作進行", "制作進行補佐", "制作", "制作協力", "制作担当", "制作デスク",
    "制作マネージャー", "設定制作", "背景進行",
    "アニメーション制作担当", "アニメーション制作協力", "アニメーション制作",
    "製作", "製作進行",
    # Original work
    "原作", "原案",
    # Effects / CG
    "特殊効果", "特効", "エフェクト", "CG", "CGI監督", "3DCG", "CGワークス",
    # Layout / Edit
    "レイアウト", "編集", "ビデオ編集",
    # Music / Theme songs
    "作曲", "作詞", "編曲", "主題歌", "うた",
    # Additional production / support
    "企画", "協力", "製作担当", "設定補佐", "宣伝協力",
    "録音助手", "録音スタジオ", "現像",
    # Extended supervision / assistance
    "メカ作画監督", "作画監督協力", "美術監督補", "美術進行", "仕上進行",
    # Digital / CG extended
    "CGエフェクト", "デジタル彩色", "レタッチ", "背景スキャン",
    "ゼログラフ", "ネガ編集", "記録",
    # Other common
    "アニメーション", "WEB担当", "調整", "脚本協力",
    "担当制作", "シナリオ", "3Dモデリング", "忍術創案",
    "歌", "宣伝", "設定進行", "助監督", "選曲",
    "プロデュース", "タイミング", "美術補佐", "美術ボード",
    "メカデザイン協力", "番組宣伝", "文芸担当",
    # CG / 3D extended
    "モデル制作", "モデリング", "モーション", "コンポジット",
    # Extended direction
    "チーフディレクター", "ユニットディレクター", "副監督補佐",
    # Extended sound
    "整音", "ミキサー", "MA", "選曲・効果",
    # Misc credits
    "キャラクター著作", "プロップデザイン", "設定協力",
    "Arrangement", "制作事務",
    ...
    "ストーリーボード", "コンセプトデザイン", "デジタルペイント検査",
    "製作協力", "仕上協力", "進行", "CG制作", "CGディレクター",
    "背景制作", "演助進行", "編集助手", "アニメーション絵コンテ",
    "美術担当", "作画監督補", "オフライン編集", "著作",
    "デジタル合成", "CGI", "仕上チェック", "文芸",
    "広報", "スペシャルサンクス", "スタジオコーディネート",
    "アクション原画", "メインアニメーター", "レイアウト作画監督",
    "原作協力", "美術監修", "キャラクター原案", "原作イラスト",
    # LLM-flagged common unknowns
    "エグゼクティブプロデューサー", "録音調整", "制作プロダクション",
    "製作著作", "共同制作", "バトル監修", "美術デザイン",
    "オープニングディレクター", "オープニング演出", "エンディング演出",
    "イラスト", "トレス", "タイトル", "色彩指定",
    "仕上げ管理", "動画チェック補", "線撮協力", "企画協力",
    # LLM validation round 2
    "製作総指揮", "音響演出", "基本設定", "技術協力",
    "ライティング", "アソシエイト", "CGスーパーバイザー",
    "音響制作協力", "制作デスク補佐", "編成",
    "動画編集", "管理",
    # LLM validation round 3
    "チーフプロデューサー", "プランニングマネージャー", "音響プロデューサー",
    "アニメーション監督", "色指定補", "監修", "題字",
    "アシスタント", "ラインテスト", "トレース", "音響",
    "スタジオ", "オリジナルサウンドトラック", "漫画",
    "制作統括", "音楽A&R",
    # LLM validation round 4
    "作画監督チーフ", "演出チーフ", "タイトルロゴデザイン",
    "キャラクター設計", "落語監修", "監修協力", "SF考証",
    "製作助手", "音楽担当", "アニメーションキャラクター",
    "メカ・エフェクト作画監督", "色指定補佐",
    # === Bulk addition: freq >= 10 unknown roles (manually classified) ===
    # CG / 3D
    "2Dエフェクト", "CG制作進行", "CG進行", "3DCG制作", "CGIデザイナー",
    "CGアニメーター", "CGモデラー", "CGモデリング", "CGIディレクター",
    "CGI協力", "CGプロデューサー", "CG制作協力", "CG監督",
    "CGプロダクトマネージャー", "CGモデリングチーフ", "CG制作プロデューサー",
    "CGIプロデューサー", "3DCGI", "3D", "3D美術", "3DLO", "3DLOリード",
    "3Dレイアウト", "2Dワークス", "2Dデザイン", "2Dモニターワークス",
    "3D.C.G", "CGデザイナー", "コンポジットディレクター",
    "背景3Dモデリング", "キャラクターモデリング", "モデラー", "モデリング協力",
    "シニアデジタルアーティスト", "デジタルアーティスト",
    # 作画 extended
    "動画作監", "原画作監", "作監", "作監補", "キャラ作監", "メカ作監",
    "キャラクター作画監督", "メカニック作画監督", "メカニカル作画監督",
    "アクション作監", "動物作画監督", "プロップ作画監督",
    "総作画監督補佐", "総作画監督補", "総作監補佐", "エフェクト作画監督",
    "レイアウト監修", "作画監修", "エピローグ総作画監督",
    "原画作監補佐", "作画協力", "動画協力", "原画協力",
    "リードアニメーター", "アニメーションディレクター",
    "アニメーションキャラクターデザイン", "キャラクターデザイン協力",
    "サブキャラクターデザイン協力", "ゲストデザイン", "クリーチャーデザイン",
    "ビジュアルデザイン", "原画設計", "画コンテ",
    "ストーリィボード", "アニメーションストーリーボード",
    "変身原画", "アクション作画",
    # 仕上 extended
    "仕上助手", "仕上特効", "仕上検査補佐", "仕上げ協力",
    "ペイント", "ペイント検査補佐", "彩画", "検査補佐", "検査協力",
    "デジタル仕上", "デジタル仕上げ", "デジタル検査", "デジタル動画検査",
    "色指定仕上検査", "デジタル特効", "デジタル動画",
    "動画チーフ", "動仕制作",
    # 編集 extended
    "オンライン編集", "HD編集", "フォーマット編集",
    "デジタル編集",
    # 撮影 extended
    "コンポジット撮影", "撮影協力", "撮影チーフ",
    "モニターワークス", "モニターグラフィック", "モニターグラフィックス",
    "スキャン", "スキャニング", "フィルム",
    # 美術 extended
    "美術監督補佐", "美術協力", "美術背景", "美術統括",
    "背景協力", "背景管理", "背景監修",
    # 設定 extended
    "設定管理", "画面設計", "原図", "原図整理", "原図監修",
    "衣装デザイン", "衣装協力", "服装設定",
    "キャラクター監修",
    # 音響 extended
    "音楽制作協力", "音楽ディレクター", "サウンドミキサー",
    # 演出 extended
    "演出補", "演出協力", "ディレクター",
    # 制作管理 extended
    "制作管理", "制作プロデューサー", "CG制作プロデューサー",
    "宣伝プロデューサー", "制作進行チーフ", "文芸進行",
    "モデル協力", "モデル進行管理", "進行協力",
    # デザイン extended
    "デザイン協力", "ロゴデザイン", "タイトルデザイン",
    "ゲストキャラクター原案",
    # Special (non-production)
    "セールスプロモーション", "ライセンス", "ライセンス担当",
    "海外セールス", "海外担当", "海外ライセンス", "配給", "配給営業",
    "劇場営業", "番組担当", "番組協力", "取材協力",
    "協力プロダクション", "協力スタジオ", "編集スタジオ",
    "WEB制作", "公式サイト制作", "システム管理",
    "宣伝担当", "宣伝パブリシティ",
    "操演", "実写ディレクター", "実写制作協力",
    "キャスティング協力", "コーディネーター",
    "フォント協力", "プロモーション協力",
    # 音楽 extended
    "挿入歌", "ボーカル", "Lyrics", "Music", "Artist",
    "エンドカードイラスト", "エンドカード", "PV制作",
    "アイキャッチ", "予告アニメーション", "提供原画",
    "振り付け", "楽器監修", "主題歌協力",
    # 制作補助
    "補佐", "デジタル作画", "原案協力",
    "スーパーバイザー", "デジタル制作", "ツール開発",
    "モーションアドバイザー", "ゲストメカニックデザイン",
    # その他（作品固有だが一応認識）
    "児童画", "WEBプロモーション", "作品提供",
    "メカニカルコーディネーター",
    ...
    "録音監督", "音響制作デスク", "音響調整",
    # 制作管理系
    "プロダクションマネージャー", "プロデューサー補", "製作補",
    # 文芸系
    "文芸助手", "脚本構成",
    # CG / ポスプロ
    "3DCG監督", "デジタル特殊効果", "テレシネ",
    # デザイン / 設定系
    "美術設定監修", "デザイン監修", "色設定", "アクセサリーデザイン案",
    # 協力 / プロデュース
    "プロデュース協力", "キャスティング",
    # 音楽系
    "演奏", "指揮", "OPテーマプロデューサー", "OPテーマ音楽制作協力",
    # 放送 / メディア
    "NETプロデューサー", "データ放送", "掲載",
    # 監修
    "時代考証",
    ...
    # アニメーション協力 / 制作協力系
    "アニメーション協力", "アニメーション制作統括", "アニメーション共同制作",
    "制作事務統括", "制作助手", "制作補佐", "制作チーフ", "制作アシスタント",
    "制作広報", "制作デスク補",
    # 振付
    "ダンス振付", "振付",
    # 動画検査系
    "動画検査補佐", "動画管理", "動画検査・デジタル修正",
    # 作画監督系
    "作監協力", "作監補佐",
    "アクション・エフェクト作画監督", "チーフアニメーター",
    "キャラ原図・総作画監督",
    # キーアニメーター
    "キーアニメーター",
    # VFX / デジタル系
    "ビジュアルエフェクト", "デジタルワークス", "デジタルコンポジット",
    "2DCG", "2DVFX", "デジタル・ペイント",
    "2DCGデザイン", "2Dグラフィックス", "2Dグラフィック", "2Dデジタル",
    "2Dデザインワークス", "2Dモニター",
    "ビデオワークス", "VTRワーク", "VTR編集",
    "デジタルエフェクト",
    # 演出系
    "アニメーション演出", "演出補佐", "チーフ演出", "シリーズ演出",
    "監督補佐", "監督補", "監督助手",
    # 3D系
    "3Dアニメーター", "3D監督", "3DCGディレクター", "3DCGIディレクター",
    "3Dディレクター", "3DCGプロデューサー", "3DCGチーフ", "3DCGワークス",
    "3D制作", "3Dワーク", "3Dマネジメント", "3D制作進行", "3Dプロデューサー",
    "3DCG制作協力", "3DCG協力", "3DCGモデリング",
    # 撮影系
    "撮影チーム長", "BGスキャニング", "撮影管理",
    "撮影制作", "撮影監修", "副撮影監督", "撮影監督補", "撮影助手",
    # 編集系
    "VTR編集", "オンライン編集担当", "HD編集助手", "HD編集担当",
    "HD編集スタジオ", "HDビデオ編集", "HD編集制作担当", "HD編集室",
    "HD編集アシスタント", "オフライン編集助手", "オフライン編集スタジオ",
    "オフライン編集協力", "編集協力", "編集アシスタント", "編集補佐",
    "編集デスク", "映像編集", "ビデオ編集スタジオ", "ビデオ編集デスク",
    "ビデオ編集助手", "ビデオフォーマット編集",
    # ポストプロダクション
    "ポストプロダクション", "フィルムレコーディング",
    # 音響系
    "アシスタントミキサー", "サウンドエディター", "サウンド・エディター",
    "サウンドデザイン", "サウンド・ミキサー", "サウンドミキサー",
    "音響効果助手", "効果助手", "音響スタジオ", "音響監督助手",
    "音響製作", "音響助手", "音響担当", "録音制作", "録音演出",
    "録音ディレクター", "録音エンジニア", "録音アシスタント", "録音技術",
    "レコーディングスタジオ", "レコーディングエンジニア",
    "アフレコ演出", "アフレコスタジオ", "収録スタジオ", "ダビングスタジオ",
    "オーディオディレクター", "MAスタジオ",
    "フォーリー",
    # 音楽系
    "作編曲", "音楽製作", "音楽制作担当", "音楽プロデュース",
    "音楽アシスタントプロデューサー", "音楽ディレクター",
    "音楽演出", "音楽コーディネーター", "A&R",
    "歌唱", "ピアノ演奏", "Guitar", "Bass",
    "作詞・作編曲", "作詩・作曲", "作詩",
    "サウンドトラック盤", "オリジナルサウンドトラック盤",
    "主題歌プロデュース", "主題歌制作",
    # プロデューサー系
    "ラインプロデューサー", "協力プロデューサー",
    "アニメーション制作プロデューサー", "企画プロデューサー",
    "エグゼクティブ・プロデューサー", "エクゼクティブプロデューサー",
    "共同エグゼクティブプロデューサー", "共同プロデューサー",
    "クリエイティブプロデューサー", "コンテンツプロデューサー",
    "COプロデューサー", "アソシエイツプロデューサー",
    "製作プロデューサー", "企画営業プロデューサー", "ゼネラルプロデューサー",
    "総合プロデューサー", "アニメーションプロデュース",
    "担当プロデューサー",
    # 制作管理系
    "プロダクションマネージャー", "プロダクション・マネージャー",
    "プログラムマネージャー", "プロダクトマネージャー",
    "CGプロダクションマネージャー",
    "製作統括", "製作管理", "製作デスク", "製作補",
    # 宣伝・マーケティング系
    "プロモーション", "宣伝広報", "宣伝プロデュース", "宣伝デザイン",
    "広報担当", "マーケティングディレクター",
    "プロダクション営業", "プロダクションデザイン",
    "セールスプランニング", "ライセンシング",
    "販促", "販促担当", "販売プロモーション",
    # デザイン系
    "モンスターデザイン", "セットデザイン", "コスチュームデザイン",
    "メインキャラクターデザイン", "オリジナルキャラクターデザイン",
    "キャラクターデザイン原案", "キャラクターデザイン補佐",
    "キャラクター・デザイン", "ゲストキャラクター・デザイン",
    "キャラクター設定", "キャラクター設定協力",
    "プロップ・サブキャラクターデザイン", "プロップ・衣装デザイン",
    "プロップデザイン協力", "サブデザイン",
    "メカ・プロップデザイン", "サブメカニックデザイン",
    "メカニック・デザイン", "メカニカル・デザイン",
    "デザインワーク", "グラフィックデザイン",
    "テクスチャーデザイン", "カラーデザイン",
    "モニターデザイン", "マテリアルデザイン",
    "メインタイトルデザイン", "メインタイトル", "サブタイトルデザイン",
    "公式サイトデザイン", "公式HPデザイン",
    "イメージボード", "ビジュアルアート", "ビジュアルコンセプト",
    # 美術系
    "美術助手", "美術設定協力", "美術設定補佐",
    "背景デザイン", "背景担当", "背景監督",
    # 設定系
    "設定デザイン", "設定担当", "設定マネージャー", "設定考証", "設定考証協力",
    "小物設定", "小物デザイン", "衣装デザイン協力", "衣装コンセプトデザイン・アシスタント",
    # 色彩系
    "色彩設計補", "色彩設計/指定検査", "色彩設計・指定検査", "色彩設定補佐",
    "カラーコーディネイト", "カラリスト",
    # テロップ / タイトル
    "テロップ", "タイトルリスワーク", "タイトル・リスワーク", "リスワーク",
    "タイトルロゴ", "筆文字", "サブタイトル", "サブタイトル題字",
    # CG系追加
    "CGラインディレクター", "CGテクニカルディレクター",
    "モデリングディレクター", "モデリング/リギング", "モデリング・リギング",
    "CG制作担当",
    # 文芸系
    "文芸制作", "文芸協力", "文芸設定",
    "ストーリーエディター", "ストーリー原案", "チーフライター",
    # web / HP
    "ホームページ制作", "公式ホームページ制作", "公式HP制作",
    "公式ホームページ", "オフィシャルHP制作", "オフィシャルサイト",
    "ウェブデザイン", "web制作", "Web制作", "Web担当", "WEBデザイン",
    "web・モバイル制作", "ホームページ", "HP制作", "携帯サイト",
    # 版権 / ライセンス
    "版権制作", "版権担当", "版権管理", "ライツ", "ライツ担当",
    "ライツプロモート", "国内ライセンス", "MDライセンス担当",
    # 特殊
    "特別協力", "作品協力", "資料協力", "プラグイン協力",
    "キャスティングマネージャー", "エディター", "ビデオエディター",
    "アドバイザー",
    "アシスタントエンジニア", "テクニカルディレクター",
    # OP/ED/PV系
    "オープニングアニメーション", "OP/EDアニメーション",
    "予告編ディレクター", "予告編制作",
    "コミック連載", "漫画連載", "コミカライズ", "ノベライズ",
    "コミック", "コミック協力", "連載協力",
    # 制作委員会（記録用）
    "製作委員会",
    # カード原画（作品固有）
    ...
    # スタジオ関連
    "スタジオ制作担当", "演技事務",
    "ストーリーボード", "アニメーションストーリーボード",
    # その他
    "デザイン", "担当", "AP", "EED",
    "配信", "販売", "製作・発売", "マーケティング",
    "BGスキャン", "撮影 / 編集 / モーショングラフィックス",
    "モーショングラフィックス",
    "パブリシティ", "パブリックデザイナー",
    "デジタル管理", "システム",
    "企画監修", "企画担当", "企画制作", "企画営業", "企画設定協力",
    "シリーズ監修", "クリエイティブディレクター", "チーフ・ディレクター",
    "アクション監修", "アクション監督", "アクションディレクター",
    "特技監督",
    "銃器デザイン", "武器デザイン",
    "原作監修", "原作担当",
    "ロケハン協力", "ロケーション協力", "車両協力",
    "出版協力",
    "デスク",
    "エフェクト開発", "スクリプト開発",
    "アニマティックアーティスト",
    "レーベル", "曲名", "Illustrator", "lyrics",
    "現像所", "ラボ・プロデューサー", "ラボマネージャー",
    "プロモーター", "宣伝・販促",
    "チーフマネージャー",
    "アニメーションツール",
    "放送進行協力",
    ...
    "キャラクター", "メカニック",
    # CG / 3D追加
    "CGアニメーション", "3D.C.G.I", "3Dアニメーション", "3DCGアニメーション",
    "3DCGアニメーター", "CGバックグラウンド", "CGI制作", "CGアセット",
    "3D背景", "CGカメラワーク",
    # ツール / テック
    "ツール・スクリプト開発",
    # 仕上系追加
    "仕上げ検査補佐", "彩色チェック", "色指定・色検査",
    # デザイン / 背景追加
    "背景レイアウト", "サブ・小物",
    # デジタル
    "デジタルワーク", "2Dエフェクト&コンポジット",
    # 翻訳
    "翻訳",
    # アイキャッチ
    "アイキャッチ原画", "提供バックイラスト",
    # 作品固有だが高頻度
    "プリ☆チャンライブ演出", "プリパラライブ演出",
    # freq >= 30 の一般ロール
    "カット制作・モデリング協力",
    "色彩設計/指定検査",
    "ストーリーエディター",
    ...
    # 作画系
    "ペイント検査", "エフェクト作監", "第一原画",
    "キャラ作画監督", "総作監", "モンスター作画監督",
    "料理作画監督", "動検", "動画監督",
    "原画作画監督補佐", "総作画監督協力", "仕上検査協力",
    "BANK原画", "BANK管理",
    # 演出・絵コンテ系
    "絵コンテ協力", "演助", "次回予告",
    # 制作進行系
    "進行補佐", "制作話数担当", "仕上管理", "仕上制作",
    # CG系
    "CGスタッフ", "CGアーティスト", "CGIアート", "CGIチーフデザイナー",
    "CG制作管理", "CG協力", "3D-CGI", "3Dモデラー",
    "3DCGデザイナー", "3Dワークス", "3DCG制作進行", "CG背景",
    "2D撮影",
    # デザイン系
    "モデリングデザイナー", "デザイナー", "チーフデザイナー",
    "ゲストモンスターデザイン", "クリーチャーデザイン協力",
    "サブキャラクター設定", "サブ設定協力",
    "小物・エフェクト設定",
    # レイアウト
    "レイアウト協力",
    ...
    "美術ボード協力",
    # イラスト系
    "イラストレーション", "エンディングイラスト", "アイキャッチイラスト",
    # 撮影系
    "撮影担当", "デジタル背景", "実写撮影", "TAP",
    # 配信系
    "配信担当",
    # === Round 4 (2026-03-16, freq >= 20 体系的追加) ===
    # ---- 動画仕上系 (表記揺れ: 動仕 は登録済み) ----
    "動画仕上", "動画仕上げ", "動画仕上管理", "動画仕上進行",
    "動画仕上協力", "動仕協力",
    # ---- レイアウト系 ----
    "レイアウトチェック", "レイアウト・チェック", "レイアウトチェッカー",
    "レイアウト修正", "メインレイアウト", "レイアウト作監",
    "レイアウト作画監督補佐",
    # ---- 作画系 追加 ----
    "原画作画監督", "チーフ作画監督", "特別作画監督",
    "メカ総作画監督", "キャラクター総作画監督",
    "アクション・ユニット作画監督", "アクション・エフェクト作監",
    "銃器作画監督", "ライブパート作画監督", "メカニック作監",
    "クリーチャー総作画監督", "キャラクター作監",
    "メカニック作画協力", "アクション作画監督補",
    "キャラクター作画監督協力", "キャラクター作画監督補佐",
    "メカ作画監督協力", "メカ修正", "総作監補", "総作画監修",
    "作画監修協力", "メカニックワーク",
    "ED原画", "OP原画", "BANK原画", "後提供イラスト",
    "アクションアニメーター", "リードキャラクターアニメーター",
    "若手原画", "二原", "二原画", "二原協力", "第1原画",
    "予告原画", "予告作画", "オープニング原画", "エンディング原画",
    "アバン原画", "カラー原画", "歴代プリキュア原画",
    "動画サポーター", "原絵師", "絵師頭",
    "割絵",
    # ---- 仕上系 追加 ----
    "仕上検査補", "仕上げ検査補佐", "仕上げ検査協力",
    "仕上げチーフ", "仕上げ助手", "仕上処理",
    "彩色検査", "色指定助手", "色指定検査補佐",
    "セル検", "セル検査補佐", "検査補", "チェック補",
    "ペイント協力",
    "色検査", "色彩", "動画チェック補佐",
    # ---- デジタル / TP系 ----
    "TP", "TP協力", "TP修正", "DIGITAL.TP",
    "デジタル修正", "デジタル処理",
    "デジタルシネママスタリング", "デジタルシネマエンジニア",
    "デジタル撮影監督", "デジタル撮影&VFX",
    "デジタル進行", "デジタル制作管理", "デジタル背景",
    "デジタルラボ", "デジタルCG制作",
    "コンピューター処理",
    # ---- CG系 追加 ----
    "CG美術", "CG作成", "CGコンポジター",
    "CGモデリング協力", "CGチーフデザイナー", "CGチーフ",
    "オリジナルCGモーション制作", "CG制作デスク",
    "CGIテクニカルディレクター", "CGI制作進行",
    "CGIアシスタントプロデューサー", "CGIモデリングディレクター",
    "CGIキャラクターテクニカルディレクター",
    "CGIラインマネージャー", "CGIチーフデザイナー",
    "CGラインプロデューサー", "CGリードアニメーター",
    "CGレタッチ", "CGレイアウト", "CGディレクター助手",
    "CGモデリング・開発", "CGモデリング・リーダー",
    "CGモデリングディレクター", "CG監督補佐・CGデザイナー",
    "CG演出", "CG設定制作", "CGアセットデザイナー",
    "CGアートディレクター", "CGアート", "CGデザイン",
    "CGテクニカルデザイナー",
    "CG制作コーディネーター",
    # ---- 3D系 追加 ----
    "3D撮影", "3DCGI協力", "3D.CGI", "3DC.G.I", "3CGI",
    "3DCGチーフアニメーター", "3DCGスタッフ", "3DCG検査",
    "3DCGワーク", "3DCGIアニメーター", "3DCGIワークス",
    "3DCGI制作", "3DCGマネージャー", "3DCG撮影",
    "3Dデザイナー", "3Dデザイン", "3Dコンポジット", "3DBG",
    "3Dモデリング協力", "3D技術協力", "3Dスペシャルエフェクト",
    "3Dデザイン・モデリング", "3D協力",
    # ---- 2D系 追加 ----
    "2Dworks", "2DWorks", "2DCGI", "2DCGチーフ",
    "2D背景", "2Dワーク", "2Dエフェクトチーフ",
    "2Dコンポジット&エフェクト", "2Dモニターワーク",
    "2DCGデザイン", "2Dデザイン協力", "2Dマテリアルデザイン",
    # ---- コンポジット / 撮影系 追加 ----
    "コンポジター", "コンポジッター", "リードコンポジッター",
    "リードコンポジター", "コンポジット制作担当",
    "SCAN", "背景スキャニング", "背景デジタル処理",
    "撮影進行", "背景3D", "背景3Dモデリング",
    "背景モデリング", "背景チーフ", "背景統括",
    "背景補正", "背景レタッチ", "背景制作進行",
    "背景監督補", "背景進行補佐", "背景用モデリング",
    # ---- 演出系 追加 ----
    "演出監督", "コーナー監督", "担当演出", "演出サポート",
    "演出統括", "OP演出", "ED演出", "ライブ演出",
    "ライブパート演出", "絵コンテ・演出担当", "絵コンテ演出",
    "絵コンテ清書", "コンテ協力",
    # ---- 美術系 追加 ----
    "美術制作", "美術設計", "美術補正", "美術話数担当",
    "美術3D作業", "美術デジタルワークス", "美術監督捕",
    "美術・設定監督", "各話美術デザイン", "美術デザイン協力",
    "美術デザイン補佐", "美監補佐", "担当美術",
    "話数背景担当",
    # ---- 設定系 追加 ----
    "画面設定", "メカ設定", "メカ設定協力", "銃器設定",
    "設計補佐", "設定・資料", "設定制作補佐", "設定制作進行",
    "設定補", "料理設定", "服装デザイン",
    # ---- デザイン系 追加 ----
    "サブキャラデザイン", "ゲストキャラクターデザイン協力",
    "ちびキャラデザイン", "ゲストメカデザイン",
    "ゲストメカニカルデザイン", "メカデザイン補佐",
    "メカデザインワークス", "メカニックデザイン協力",
    "オープニングデザイン", "エンドカードデザイン",
    "フォントデザイン", "テロップデザイン", "UIデザイン",
    "貼り込み素材デザイン", "コンセプトアート", "コンセプトデザイン協力",
    "ビジュアルワークス", "ビジュアルディレクター",
    "プロップ作監", "プロップ監修", "プロップ協力",
    "プロップデザイン補佐", "ゲストプロップデザイン",
    "スピリットデザイン", "クリーチャーモデリング",
    "コスチュームデザイン協力", "キャラモデラー",
    # ---- モデリング / リギング ----
    "モデリングスーパーバイザー", "モデリングアーティスト",
    "モデリングチーフ", "モデリングリード", "モデリングコーディネーター",
    "リガー", "リギング", "リギングスーパーバイザー",
    "セットアップ",
    # ---- モーション ----
    "モーションキャプチャー", "モーションデザイナー", "モーションディレクター",
    "モーショングラフィック",
    # ---- 監修系 ----
    "エフェクト監修", "LO監修", "特殊効果監修", "脚本監修",
    "シナリオ監修", "特効監修",
    # ---- エフェクト ----
    "エフェクトディレクター", "エフェクトスーパーバイザー",
    "エフェクトデザイナー", "エフェクトアーティスト",
    "エフェクト原案", "AE・特効",
    "エアブラシワーク",
    # ---- 制作管理系 追加 ----
    "制作コーディネーター", "制作進行アシスタント", "制作進行補",
    "制作進行協力", "制作担当補佐", "制作サポート", "制作応援",
    "制作宣伝", "進行チーフ", "制作チーフ",
    "プロジェクトマネージャー", "ラインマネージャー",
    "フロアマネージャー", "アシスタントマネージャー",
    "ショットマネージャー", "アセットマネージャー",
    "アセットチーフ", "アセットテクニカルディレクター",
    "スタッフマネージャー", "マネージャー", "システムマネージャー",
    "テクニカルスーパーバイザー", "テクニカルアドバイザー",
    "テクニカルサポート",
    "ラボコーディネーター", "ラボ・マネージメント", "ラボ・デスク",
    "システム・マネージメント", "システムエンジニア",
    "OP制作進行", "ED制作進行", "話数制作担当",
    # ---- 音響系 追加 ----
    "録音進行", "整音助手",
    # ---- 音楽系 追加 ----
    "エンディングテーマ", "コーラス", "ベース", "ドラム", "Drums",
    "トランペット", "Horn", "Vocal", "Strings",
    "作曲&編曲", "楽曲コーディネート", "楽曲制作協力",
    "楽器作監", "音楽録音", "音楽宣伝",
    "ミキサー", "ミキシングエンジニア", "ミックスエンジニア",
    "レコーディング&ミキサー", "レコーディング&ミキシングエンジニア",
    "レコーディング&ミックスエンジニア",
    # ---- 声優 / ナレ系 ----
    "ナレーション", "パーソナリティ", "ダンサー", "出演",
    "方言指導", "俳優担当",
    # ---- 営業 / プロモ系 追加 ----
    "劇場宣伝", "パッケージ営業", "海外販売", "海外営業",
    "海外渉外", "海外プロモート", "海外セールス担当",
    "配給統括", "配給調整", "配信担当",
    "プロモート", "宣伝統括",
    "ライセンシング", "商品化担当", "製作業務",
    "パッケージ制作", "パッケージ製造",
    "統括プロデューサー", "アドバイザリープロデューサー",
    # ---- 翻訳 / 海外 ----
    "和訳", "通訳", "翻訳協力", "韓国語通訳・翻訳",
    # ---- 実写系 ----
    "実写協力", "実写撮影",
    # ---- 色彩追加 ----
    "カラーコーディネーター", "カラーマネジメント",
    "ゲスト色彩設計", "ゲスト色彩設計・色指定",
    "色設計・検査", "色指定・検査・貼込", "色指定補助",
    # ---- 編集系 追加 ----
    "ビデオ編集担当", "VIDEO編集", "フォーマット編集担当",
    "DCPマスタリング",
    # ---- イラスト系 追加 ----
    "アイキャッチ作画", "アイキャッチデザイナー",
    "エンドイラスト", "提供イラスト", "予告イラスト",
    "イラスト協力", "次回予告イラスト", "劇中イラスト",
    "絵本イラスト", "EDカードイラスト", "ENDカード原画",
    # ---- OP/ED制作系 ----
    "エンディング制作", "エンディングディレクター",
    "OP作画監督", "ED作画監督",
    # ---- 脚本系追加 ----
    "脚色", "脚本制作", "脚本事務", "脚本進行",
    "ストーリー", "ストーリー/脚本",
    ...
    # ---- Live2D / VFX ----
    "VFXスーパーバイザー", "Live2Dアニメーター",
    # 正規化先のbase roles
    "チーフ", "リード",
    # Round 5.5: 最終残りロール
    "オペレーター", "エンジニア", "調整助手", "技術",
    "BG補正", "タッチ/ブラシ", "データチェック",
    "販売促進", "配信ライセンス", "統括",
    "VE", "HDレコーディング", "特殊演技",
    "検査補助", "フォト・タイプ",
    "トリック案", "動画仕上げ管理",
    "第弐原絵師", "藝頭", "原絵師",  # 大江戸ロケット固有
    "狂言", "予告マンガ",
    "撮影・SFX", "特技効果・デザインワークス",
    "一部作曲・原曲", "一部原曲・作曲",
    "原画作監補", "words",
    # === Round 5 (2026-03-16, 残り一般ロール freq >= 20) ===
    "動画検査協力", "リードCGアニメーター", "リードモデラー",
    "オンライン編集助手", "サブキャラクター",
    "アニメオリジナルカード絵作画",
    "リードアーティスト",
...
_METADATA_ROLES: set[str] = {
    ...
    "前番組", "次番組", "同時ネット",
    "配信開始", "配信期間", "配信日",
    "公開日", "公開時期", "劇場公開日", "初回上映日", "初回放送日",
    "上映時間", "上映期間", "放送話数", "全話",
    "公開", "封切", "発売日",
    "発売元", "発売時期", "収録時間", "配信話数", "配信時期",
    "販売元", "発売", "国内配信",
    # Show-specific episode naming conventions (not credit roles)
    "Episode", "EPISODE", "Karte", "PHASE", "Phase",
    "CHAPTER", "Chapter", "ROGUE", "Mission", "FILE", "File",
    "stage", "Stage", "Act", "Program", "OPERATION",
    "Focus", "border", "trap", "track", "Order", "Qubit",
    "Steal", "Load", "CODE",
}

# TV番組コーナー名・冗談系 — credit lineとしてパースしない
_JOKE_CORNER_SUBSTRINGS: tuple[str, ...] = (
    "ポケモン講座", "ポケモン川柳", "ポケモントリビア", "お題のポケモン",
    "ポケモンライブキャスター", "ポケモンホロキャスター",
    "ポケモン大百科", "ポケモン大検定",
    "バトスピ講座", "アプモンデータラボ", "アプリ格言",
    "バディポリス講座", "バスケットボール講座",
    "トリビアクイズ", "ミニコーナー",
    "DUEL", "MISSION",
    "こたえ", "ヒント", "投稿", "正解", "問題",
    "じゃんけん", "選択肢", "答え", "プププつうしん",
    "カード紹介", "今日のカード", "今週の一番星", "今日のフェアリル",
    "猿田教官の補習授業", "スカッとカスカベ",
    # Detected from 300-page quality audit
    "今日の格言", "キャプテン今日の格言",
    "FCイナズマイレブン", "びっくりラッキーマンボ", "Trick",
    "ラッキーマン", "ガッツポーズ", "次回予告ナレーション",
    # Show-specific episode naming used as section headers
    "どこでもドアかくれんぼ",
    "ジャスティス・カザミ", "Re:RISE NEWS",
)
...
_COMPANY_EXACT: set[str] = {
    "ぴえろ", "ガイナックス", "GAINAX", "XEBEC", "ゼクシズ",
    "サンライズ", "SUNRISE", "ボンズ", "BONES", "SHAFT",
    "マッドハウス", "MADHOUSE", "ゴンゾ", "GONZO",
    "タツノコプロ", "トムス", "TMS", "OLM", "SILVER LINK.",
    "MAPPA", "WIT STUDIO", "ufotable", "CloverWorks",
    "A-1 Pictures", "京都アニメーション", "東映アニメーション",
    "ぎゃろっぷ", "J.C.STAFF", "P.A.WORKS",
    # Detected as UNKNOWN roles in full scan (studio section headers)
    "マジックハウス", "ジェイ・フィルム", "ECHOプロ",
    "ブレインズ・ベース", "エー・ライン",
    "美峰デジタルワークス", "美峰", "はだしぷろ", "バップ",
    "デジタルバスキュール", "IMAGICA", "イマジカ",
}
...
async def fetch_page_list(
    ...
    for a_tag in soup.select("a[href]"):
        ...
        if "/w/radioi_34/d/" in href:
            ...
            if title:
                full_url = f"https://seesaawiki.jp{href}" if href.startswith("/") else href
...
async def fetch_all_page_urls(
    ...
    for page_num in range(87):  # ~87 list pages (100 items each)
        try:
            ...
            log.warning("seesaa_list_page_error", page=page_num, status=e.response.status_code)
            break
    ...
    cache_path.write_text(json.dumps(all_pages, ensure_ascii=False, indent=2), encoding="utf-8")
...
def extract_wiki_body(html: str) -> str:
    ...
    for tag in body.find_all(["script", "noscript", "style", "iframe", "object",
                               "embed", "form", "input", "select", "textarea",
                               "nav", "footer", "header"]):
        tag.decompose()
    # Remove ad/tracking divs (SeesaaWiki patterns)
    for div in body.find_all("div", class_=lambda c: c and any(
        kw in c for kw in ("ad-", "ads-", "ad_", "ads_", "seesaa-ad",
                            "page-info", "page-footer", "side-bar",
                            "ad-label", "page-navi", "comment"))):
        div.decompose()
    for div in body.find_all("div", id=lambda i: i and any(
        kw in i for kw in ("ad", "comment", "navi", "footer", "sidebar"))):
        div.decompose()
...
_RE_EP_RANGE = re.compile(
    r"(?:第\s*)?(\d+)\s*話?\s*[〜~\-ー–]\s*(?:第\s*)?(\d+)\s*話?"
)
...
class ParsedCredit:
    ...
    position: int      # 0-based position within this role (0 = first listed = highest authority)
    ...
    affiliation: str | None = None  # Studio/company affiliation extracted from parenthetical
    episodes: list[int] | None = None  # Per-name episode ranges: [1,2,...,21,23,...,33,35]
    episode_from: int | None = None  # Open-ended start: N話〜 → expand at save using anime.episodes
...
def parse_credit_line(line: str) -> list[ParsedCredit]:
    ...
    if names_stripped and (names_stripped[0].isdigit() or names_stripped.startswith("「")):
    ...
    cleaned_entries: list[tuple[str, str | None, bool, list[int] | None, int | None]] = []
    for n in expanded_names:
        cleaned, affiliation, episodes, episode_from = _clean_name(n)
        if len(cleaned) >= 2:
            is_company = _is_company_name(cleaned)
            cleaned_entries.append((cleaned, affiliation, is_company, episodes, episode_from))
...
_CAST_SECTION_HEADERS: tuple[str, ...] = (
    "キャスト", "声の出演", "出演", "出演者", "CAST", "Cast",
    "ゲスト声優", "ゲストキャスト", "レギュラーキャスト",
)
    ...
    async with httpx.AsyncClient(timeout=30.0, follow_redirects=True) as client:
        ...
        for idx, page_info in enumerate(all_pages):
            ...
            save_parsed_intermediate(
                data_dir, page_title, anime_id, body_text,
                episodes, series_staff, llm_records, parser_used,
                llm_validation=llm_validation,
            )
...
def _save_credit(
    ...
    if parsed.episode_from is not None and total_episodes:
        resolved_episodes.extend(
            range(parsed.episode_from, total_episodes + 1)
        )
    ...
    if parsed.affiliation:
        ...
        if aff_key not in _affiliation_cache:
            insert_person_affiliation(
                conn, person.id, anime_id, parsed.affiliation, source="seesaawiki",
            )
...
_anime_studio_cache: set[tuple[str, str]] = set()  # (anime_id, studio_id) already inserted
_affiliation_cache: set[tuple[str, str, str]] = set()  # (person_id, anime_id, studio_name)
...
def reparse_from_raw(
    ...
    for idx, html_path in enumerate(html_files):
        ...
        save_parsed_intermediate(
            data_dir, title, anime_id, body_text,
            episodes, series_staff, llm_records, parser_used,
        )
        ...
        for ep_data in episodes:
            for credit in ep_data["credits"]:
                _save_credit(
                    conn, person_cache, stats, anime_id, credit,
                    episode=ep_data["episode"],
                    upsert_person=upsert_person, insert_credit=insert_credit,
                    total_episodes=total_episodes,
                )
        ...
        if llm_records and regex_credits < 3:
            for record in llm_records:
                pc = ParsedCredit(
                    ...
                    position=0, is_known_role=record["role"] in KNOWN_ROLES_JA,
                )
                _save_credit(
                    conn, person_cache, stats, anime_id, pc,
                    episode=record.get("episode"),
                    upsert_person=upsert_person, insert_credit=insert_credit,
                    total_episodes=total_episodes,
                )
...
def validate_samples(
    ...
    log.info(
        ...
        verdict="PASS" if issues_found == 0 else f"ISSUES ({issues_found}/{total_validated})",
    )
