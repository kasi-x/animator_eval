...
- 13.1 Card 01: Archive dump DL + 展開 (`src/scrapers/bangumi_dump.py`, `scripts/fetch_bangumi_dump.py`)
...
scraper 内部設計 (リファクタ):
  TASK_CARDS/13_scraper_runner_refactor/  ✅ 完了 (3 commits, 318 tests pass)
    ...
    keyframe phase2/3            ✅ BronzeWriter ×5/4 → BronzeWriterGroup 統合 (dict checkpoint 維持)
```
