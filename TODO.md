...
| `02_opportunity_residual_null` | OLS 残差 + analytical CI + permutation null model (現状ヒューリスティック置換) | business / 政策 |
...
| Card | 内容 | 経路 |
|------|------|------|
| `01_missingness_disclosure` | source × role × year coverage 行列、Findings 必須 caveat block | 全経路 (基盤) |
