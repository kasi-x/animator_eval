...
作成日: 2026-04-22 / 最終更新: 2026-05-15 (13 カード消化完了: 15/01, 15/03, 19/01-04, 25/02, 25/03, 26/01, 26/03, 27/01-03, 28/01, 34/01-04)
...
| 優先度 | カテゴリ | 内容 |
|--------|---------|------|
| ✅ Done | Resolved cluster | madb parent link (commit `708669d`) + tmdb/ann homonym guard (`f0d4547`) + canonical_id collision (`686e161`)、32 tests pass。README は stale (要更新) |
