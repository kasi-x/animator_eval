...
def silver_gold_dbs(tmp_path, monkeypatch):
    ...
    import src.analysis.silver_reader as sr
    import src.analysis.gold_writer as gw

    silver_path = tmp_path / "silver.duckdb"
    gold_path = tmp_path / "gold.duckdb"

    # Build minimal silver.duckdb with credits + persons
    ...
    # Build gold.duckdb with DDL from gold_writer
