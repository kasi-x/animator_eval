...
def synthetic_db(tmp_path_factory):
    ...
    orig_silver = src.analysis.io.conformed_reader.DEFAULT_SILVER_PATH
    orig_gold = src.analysis.io.mart_writer.DEFAULT_GOLD_DB_PATH
    ...
    src.analysis.io.conformed_reader.DEFAULT_SILVER_PATH = orig_silver
    src.analysis.io.mart_writer.DEFAULT_GOLD_DB_PATH = orig_gold
